...
def get_codementor_tokens(username: str, password: str):
    with sync_playwright() as p:
        ...
        page.wait_for_url('https://www.codementor.io/m/dashboard', timeout=120000)
...
if __name__ == '__main__':
    access_token, refresh_token = get_codementor_tokens('zackplauche@gmail.com', 'Z0Ro3C0Gj%M2q4sA')
